...
def _serialize_details(d: Any) -> Optional[Dict[str, Any]]:
    if not d:
        return None
    return {
        "cafe_styles": getattr(d, "cafe_styles", None) or [],
        "food_styles": getattr(d, "food_styles", None) or [],
        ...
        "bean_types": getattr(d, "bean_types", None) or [],
        "brew_methods": getattr(d, "brew_methods", None) or [],
        "specialty_coffee": getattr(d, "specialty_coffee", False),
        "non_coffee_options": getattr(d, "non_coffee_options", False),
        "signature_items": getattr(d, "signature_items", None) or [],
        "signature_drinks": getattr(d, "signature_drinks", None) or [],
        "dessert_available": getattr(d, "dessert_available", False),
        "pastry_available": getattr(d, "pastry_available", False),
        ...
        "takeaway_available": getattr(d, "takeaway_available", False),
        "delivery_available": getattr(d, "delivery_available", False),
        "laptop_friendly": getattr(d, "laptop_friendly", False),
        "good_for_work": getattr(d, "good_for_work", False),
        "good_for_study": getattr(d, "good_for_study", False),
        "meeting_friendly": getattr(d, "meeting_friendly", False),
        "power_outlets_available": getattr(d, "power_outlets_available", False),
        "power_outlet_count": getattr(d, "power_outlet_count", None),
        "wifi_available": getattr(d, "wifi_available", False),
        "wifi_speed_level": getattr(d, "wifi_speed_level", None),
        "parking_available": getattr(d, "parking_available", False),
        "restroom_available": getattr(d, "restroom_available", False),
        ...
        "instagrammable": getattr(d, "instagrammable", False),
        "natural_light_good": getattr(d, "natural_light_good", False),
        "sunrise_good": getattr(d, "sunrise_good", False),
    ...
    try:
        async with prisma.tx() as tx:
            ...
            if data.category_details:
                ...
                create_data["details"] = {
                    "create": {
                        "cafe_styles": cd.cafe_styles or [],
                        "food_styles": cd.food_styles or [],
                        ...
                        "bean_types": cd.bean_types or [],
                        "brew_methods": cd.brew_methods or [],
                        "specialty_coffee": cd.specialty_coffee,
                        "non_coffee_options": cd.non_coffee_options,
                        "signature_items": cd.signature_items or [],
                        "signature_drinks": cd.signature_drinks or [],
                        "dessert_available": cd.dessert_available,
                        "pastry_available": cd.pastry_available,
                        ...
                        "laptop_friendly": cd.laptop_friendly,
                        "good_for_work": cd.good_for_work,
                        "good_for_study": cd.good_for_study,
                        "meeting_friendly": cd.meeting_friendly,
                        "power_outlets_available": cd.power_outlets_available,
                        "power_outlet_count": cd.power_outlet_count,
                        "wifi_available": cd.wifi_available,
                        "wifi_speed_level": cd.wifi_speed_level,
                        "parking_available": cd.parking_available,
                        "restroom_available": cd.restroom_available,
                        ...
                        "instagrammable": cd.instagrammable,
                        "natural_light_good": cd.natural_light_good,
                        "sunrise_good": cd.sunrise_good,
